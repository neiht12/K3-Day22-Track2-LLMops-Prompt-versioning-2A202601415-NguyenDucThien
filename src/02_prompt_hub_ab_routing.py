...
PROMPT_V1_NAME = "nguyenducthien-day22-rag-v1"
PROMPT_V2_NAME = "nguyenducthien-day22-rag-v2"
...
SYSTEM_V1 = """Bạn là trợ lý AI hữu ích. Chỉ dùng context được cung cấp để trả lời.
Trả lời ngắn gọn bằng tiếng Việt, trong 2–4 câu. Nếu context không đủ, hãy nói rõ
bạn không có đủ thông tin thay vì suy đoán.
...
SYSTEM_V2 = """Bạn là chuyên gia AI. Chỉ dựa vào context được cung cấp, hãy xác định
các facts liên quan rồi trả lời bằng tiếng Việt với giọng điệu rõ ràng, có cấu trúc.
Trả lời trong 3–5 câu; khi phù hợp, nêu ý chính trước rồi giải thích ngắn gọn.
Nếu context không đủ, hãy nói rõ giới hạn đó và không suy đoán.
...
def push_prompts_to_hub(client: Client):
    ...
    try:
        url = client.push_prompt(PROMPT_V1_NAME, object=PROMPT_V1, description="V1 - concise Vietnamese RAG answers")
    ...
    try:
        url = client.push_prompt(PROMPT_V2_NAME, object=PROMPT_V2, description="V2 - structured expert Vietnamese RAG answers")
